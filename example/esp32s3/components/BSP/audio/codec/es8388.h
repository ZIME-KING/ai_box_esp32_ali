...
#ifndef __MY_ES8388_H_
#define __MY_ES8388_H_
...
esp_err_t es8388_read_reg(uint8_t reg_add,
                             uint8_t *p_data);    /* ES8388读寄存器 */
...
void es8388_output_cfg(uint8_t o1en,
                          uint8_t o2en); /* ES8388 DAC输出通道配置 */
void es8388_mic_gain(uint8_t gain); /* ES8388 MIC增益设置(MIC PGA增益) */
void es8388_alc_ctrl(uint8_t sel, uint8_t maxgain,
                        uint8_t mingain); /* ES8388 ALC设置 */
