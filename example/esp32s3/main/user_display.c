...
#define EXAMPLE_LCD_GPIO_DC         (GPIO_NUM_47)
#define EXAMPLE_LCD_GPIO_CS         (GPIO_NUM_5)
#define EXAMPLE_LCD_GPIO_BL         (GPIO_NUM_42)
...
/* LCD touch pins */
#define EXAMPLE_TOUCH_I2C_SCL       (GPIO_NUM_11)
...
i2c_master_bus_handle_t bus_handle_touch;     /* 总线句柄 */
...
static esp_err_t app_touch_init(void)
{
    ...
    i2c_master_bus_config_t i2c_bus_config = {
        ...
        .scl_io_num                     = EXAMPLE_TOUCH_I2C_SCL,     /* SCL管脚  */
        .sda_io_num                     = EXAMPLE_TOUCH_I2C_SDA,     /* SDA管脚  */
        .glitch_ignore_cnt              = 7,                         /* 故障周期  */
        .flags.enable_internal_pullup   = true,                      /* 内部上拉  */
    };
    /* 新建I2C总线 */
    ESP_ERROR_CHECK(i2c_new_master_bus(&i2c_bus_config, &bus_handle_touch));
...
void app_main_user_display(void)
{
